...
If you are interested in seeing the hidden R codes of the report, feel free to check and browse my GitHub project page by clicking [here](https://github.com/Amlend/Swiftkey-Text-Prediction).
...
```{r, echo = FALSE}
set.seed(1995)
wordcloud2(biFreq.df, fontWeight = "normal", fontFamily = "Comic Sans MS", color = "random-light", backgroundColor = "black")
```
...
* The Shiny app would have a simple interface where predictive results would reactively appear as the user enters the text. Speed would be critical. The usage scenario would be fairly similar to how an user types text in a cell phone to deliver short messages.