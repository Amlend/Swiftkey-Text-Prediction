...
download.file(fileUrl, destfile = "C:/Users/Amlend/Desktop/Swiftkey-Text-Prediction/Coursera-SwiftKey.zip", method = "curl")
if (!file.exists("C:/Users/Amlend/Desktop/Swiftkey-Text-Prediction/Coursera-SwiftKey")) {
  unzip(zipfile = "C:/Users/Amlend/Desktop/Swiftkey-Text-Prediction/Coursera-SwiftKey.zip", 
        exdir = "C:/Users/Amlend/Desktop/Swiftkey-Text-Prediction")
}

blogs <- readLines("C:/Users/Amlend/Desktop/Swiftkey-Text-Prediction/final/en_US/en_US.blogs.txt")
news <- readLines("C:/Users/Amlend/Desktop/Swiftkey-Text-Prediction/final/en_US/en_US.news.txt")
twitter <- readLines("C:/Users/Amlend/Desktop/Swiftkey-Text-Prediction/final/en_US/en_US.twitter.txt")
...
## Check Memory Sizes
blogsSize <- file.info("C:/Users/Amlend/Desktop/Swiftkey-Text-Prediction/final/en_US/en_US.blogs.txt")$size/1024^2
newsSize <- file.info("C:/Users/Amlend/Desktop/Swiftkey-Text-Prediction/final/en_US/en_US.news.txt")$size/1024^2
twitterSize <- file.info("C:/Users/Amlend/Desktop/Swiftkey-Text-Prediction/final/en_US/en_US.twitter.txt")$size/1024^2
...
set.seed(2020)
blogsSample <- sample(blogs, blogsLength * 0.001)
newsSample <- sample(news, newsLength * 0.001)
twitterSample <- sample(twitter, twitterLength * 0.001)
...
setwd("C:/Users/Amlend/Desktop/Swiftkey-Text-Prediction")
badwords <- readLines("full-list-of-bad-words_text-file_2018_07_30.txt")
...
saveRDS(uniFreq.df, file = "/Users/Amlend/DsCapstoneProject/unigram.RDS")
...
saveRDS(biFreq.df, file = "/Users/Amlend/DsCapstoneProject/bigram.RData")
...
saveRDS(triFreq.df, file = "/Users/Amlend/DsCapstoneProject/trigram.RData")
...
saveRDS(fourFreq.df, file = "/Users/Amlend/DsCapstoneProject/fourgram.RData")
...
saveRDS(fiveFreq.df, file = "/Users/Amlend/DsCapstoneProject/fivegram.RData")
