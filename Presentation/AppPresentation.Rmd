...
knitr::include_graphics("JHU.png")
```
...
knitr::include_graphics("swiftkey.png")
```
...
- Here is the link to the application! ~~> [Word Prediction App](https://amlendsingh.shinyapps.io/WordPredictionApp/)

- Check out this [Milestone Report](http://rpubs.com/amlendsingh/MilestoneReport) that includes the Exploratory Data Analysis and how we did the preparation for the project. 

- All the R codes of the project can also be accessed from my [GitHub](https://github.com/Amlend/Swiftkey-Text-Prediction) project page.
