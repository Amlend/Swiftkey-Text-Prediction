...
shinyUI(fluidPage(
        ...
        column(6, offset = 3,
               ...
               tabsetPanel(type = "tabs",
                          ...
                          tabPanel(strong("About"),
                                   ...
                                   a("here", href = "http://rpubs.com/amlendsingh/MilestoneReport", target = "_blank"),"."),
                                   p("All the R codes for the project are also available in my",  
                                   a("GitHub", href = "https://github.com/Amlend/Swiftkey-Text-Prediction", target = "_blank"), "account."),
                                   p("Click",
    ...
    tags$footer(br(),
                ...
                br(),
                em("By"), 
                tags$a(href = "https://www.linkedin.com/in/amlend-singh-342578162/",
                       target = "_blank",
                       em("Amlend Singh Jadaun")),
                br(),
                em("July 2020"),
                align = "right"
             )
